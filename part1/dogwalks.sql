...
('david456', 'david@example.com', 'hashed999', 'owner'),
('evewalker', 'eve@example.com', 'hashed000', 'walker');
...
((SELECT dog_id FROM Dogs WHERE name = 'Rocky' LIMIT 1), '2025-06-11 10:00:00', 60, 'Riverside Park', 'open'),
((SELECT dog_id FROM Dogs WHERE name = 'Buddy' LIMIT 1), '2025-06-12 07:45:00', 20, 'City Gardens',   'completed'),
((SELECT dog_id FROM Dogs WHERE name = 'Luna'  LIMIT 1), '2025-06-13 18:30:00', 40, 'Central Square', 'cancelled');
